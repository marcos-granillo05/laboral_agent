...
formatter_agent_instructions_v03 = """
  ...
  NOTA IMPORTANTE: law_suggestions debe contener las leyes y sugerencias que se te han pasado, sin embargo en este punto tu tarea será sintetizar 
...
pdf_generator_agent_instructions_v02 = """
# Manejo de información: 
- Recibirás la información del agente 'formatter_agent' con esta estructura:
  {
  "worker_information": {
